...
from info.models import Dept, Class, Course, User, Student, Teacher, Assign, AssignTime, AttendanceTotal, Attendance, StudentCourse
...
class InfoTest(TestCase):
    ...
    def create_student(self, usn='CS01', name='Amrut'):
    ...
    def create_teacher(self, id='CS01', name='Venkat'):
